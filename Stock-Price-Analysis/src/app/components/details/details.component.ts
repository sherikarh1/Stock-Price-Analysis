...
export class DetailsComponent implements OnInit {
  ...
  // HighchartsFuture: typeof Highcharts = Highcharts;
  // chartOptionsPredict: Highcharts.Options = {
  ...
  //   for (var i = 0; i < this.predictChart.length; i++) {
  //     this.predictData.ohlc.push([this.predictChart[i].date, this.predictChart[i].open]);
  //   }

  //   this.chartOptionsPredict.series[0]['data'] = this.predictData.ohlc;
  //   this.chartOptionsPredict.series[0]['name'] = this.ticker;

  //   this.chartOptionsPredict.title['text'] = '<h2>' + this.ticker + ' Prediction</h2>';
  //   this.updateFromInput = true;
 


  //   // for (var i = 0; i < this.predictChart.length; i++) {
  //   //   this.predictChart[i].date = [new Date(this.predictChart[i].date).getTime(), this.predictChart[i].open]
  //   // }

  //   // this.chartOptionsPredict.series[0]['data'] = this.predictChart;
  //   // this.chartOptionsPredict.series[0]['name'] = this.ticker;
  //   // this.chartOptionsPredict.title['text'] = '<h2>' + this.ticker + '</h2>';

    
  //   // if (this.isChangeNeg) {
  //   //   this.chartOptionsPredict.series[0].color = 'red';
  //   //   this.chartOptionsPredict.navigator.series[0].color = 'red';
  //   // }else if (this.isChangePos){
  //   //   this.chartOptionsPredict.series[0].color = 'green';
  //   //   this.chartOptionsPredict.navigator.series[0].color = 'green';
  //   // }else{
  //   //   this.chartOptionsPredict.series[0].color = 'black';
  //   //   this.chartOptionsPredict.navigator.series[0].color = 'black';
  //   // }
